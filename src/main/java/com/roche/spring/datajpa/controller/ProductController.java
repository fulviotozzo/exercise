...
public class ProductController 
{
  ...
  public ResponseEntity<Product> createProduct(@RequestBody Product product) 
  {
	  try 
	  {
		  Product _product = productRepository.save(new Product(product.getSku(), product.getProductName(), product.getPrice(), product.getCreationDate()));
  ...
  public ResponseEntity<List<Product>> findByDates(@RequestParam("from") String from, @RequestParam("to") String to) 
  {
	  try 
	  {
